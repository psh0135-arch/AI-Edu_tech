  ...
  return (
    <section id="webinar" className="py-24 relative overflow-hidden" ref={ref}>
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-[#D4A5A5]/60 to-transparent" />
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="glass-card rounded-3xl overflow-hidden border border-[#E7D3B1]">
              {/* Card Header */}
              <div className="bg-[#F3E8D7] px-6 py-4 flex items-center gap-3 border-b border-[#E7D3B1]">
              ...
              {/* Card Body */}
              <div className="p-6">
                <h3 className="text-slate-900 font-bold text-xl mb-1 leading-snug">
                  AI 바이브코딩
                </h3>
                ...
                <div className="space-y-3 mb-7">
                  <div className="flex items-center gap-3 bg-slate-100 rounded-xl px-4 py-3">
                    ...
                    <div>
                      <p className="text-slate-900 text-sm font-medium">2026.07.01(수) 19:00 ~ 21:00</p>
