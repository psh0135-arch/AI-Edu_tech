  ...
  return (
    <section id="webinar" className="py-24 relative overflow-hidden" ref={ref}>
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute top-1/2 left-1/4 -translate-y-1/2 w-[500px] h-[400px] bg-amber-900/10 rounded-full blur-[130px] pointer-events-none" />
      </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-slate-400 text-base leading-relaxed mb-8">
              AI 바이브코딩이 궁금하신가요?<br />
              8월 31일 무료 LIVE 특강으로 먼저 경험해보실 수 있습니다.
            </p>
              ...
              <div className="p-6">
                ...
                <div className="space-y-3 mb-7">
                  <div className="flex items-center gap-3 bg-white/5 rounded-xl px-4 py-3">
                    ...
                    <div>
                      <p className="text-white text-sm font-medium">2026.08.31(월) 18:00 ~ 21:00</p>
