...
const tools = [
  ...
  { name: 'Gemini', category: '멀티모달 AI', emoji: '♊', practice: true, color: 'from-blue-600/20 to-blue-900/20', border: 'border-blue-500/25', text: 'text-blue-400' },
  ...
  { name: 'Gamma AI', category: '프레젠테이션', emoji: '📊', practice: true, color: 'from-blue-600/20 to-yellow-900/20', border: 'border-blue-500/25', text: 'text-yellow-400' },
  ...
  { name: 'CapCut', category: '영상 편집', emoji: '✂️', practice: true, color: 'from-blue-600/20 to-yellow-900/20', border: 'border-blue-500/25', text: 'text-yellow-400' },
  ...
  { name: 'NotebookLM', category: 'AI 리서치', emoji: '📓', practice: false, color: 'from-blue-600/20 to-blue-200/20', border: 'border-blue-500/25', text: 'text-blue-400' },
  ...
  return (
    <section id="tools" className="py-24 relative overflow-hidden" ref={ref}>
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/2 right-0 w-80 h-80 bg-blue-600/10 rounded-full blur-[120px]" />
        <div className="absolute top-1/2 left-0 w-80 h-80 bg-blue-600/10 rounded-full blur-[120px]" />
      </div>
        ...
        <div className="mt-16 overflow-hidden">
          <div className="flex animate-marquee gap-6 w-max">
            {[...tools, ...tools].map((tool, i) => (
              <div
                key={i}
                className="flex items-center gap-2 px-4 py-2 glass border border-blue-500/25 rounded-full text-sm text-stone-300 flex-shrink-0"
              >
